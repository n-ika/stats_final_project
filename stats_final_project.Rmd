...
```{r echo=FALSE}
plot(order(ordered_EN$combo1), order(ordered_FR$combo1))
plot(order(ordered_EN$combo1), order(ordered_all$combo1))
plot(order(ordered_FR$combo1), order(ordered_all$combo1))
```
...
```{r echo=FALSE}
hist(boot_m_H0_FR_EN)
hist(boot_m_H0_EN_all)
hist(boot_m_H0_FR_all)
```
